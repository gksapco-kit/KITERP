...
export const SIDEBAR_APP_DESCRIPTIONS: Record<string, string> = {
  ...
  'inventory': 'Products, services, stock, plants, storage locations, and goods management.',
  'procurement': 'Purchase orders, requisitions, vendor invoices, and special procurement.',
