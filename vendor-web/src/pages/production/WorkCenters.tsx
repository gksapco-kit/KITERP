...
import { GitBranch, Plus, Trash2, Loader2, Factory, Pencil, Check } from 'lucide-react'
...
export default function ProductionWorkCentersPage() {
    ...
    <div className="space-y-4">
      <div>
        <h1 className="text-xl font-bold text-foreground flex items-center gap-2">
          <GitBranch className="w-5 h-5 text-primary" /> Work Centers & Routing
        </h1>
        <p className="text-sm text-muted-foreground mt-1">
          Machines, workstations or crews that run production operations. Assign these to routing steps on each order.
        </p>
      </div>
      ...
      <div className="bg-card rounded-2xl border border-border overflow-hidden">
        ...
        {isLoading ? (
          <div className="flex items-center justify-center gap-2 py-16 text-muted-foreground">
            <Loader2 className="w-4 h-4 animate-spin" /> Loading work centers…
          </div>
