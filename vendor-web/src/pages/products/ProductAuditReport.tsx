                ...
                <tr className="border-b bg-gray-50/30">
                  <th className="px-4 py-1.5">
                    <Select
                      ...
                      options={selectOptionsWithBlank('All', uniqueVersions.map(v => ({ value: v, label: v })))}
                    />
                  </th>
                  <th className="px-4 py-1.5" />
                  <th className="px-4 py-1.5">
                    <Select
                      ...
                      triggerClassName="h-7 text-xs"
                      options={selectOptionsWithBlank('All', uniqueUsers.map(u => ({ value: u, label: u })))}
                    />
                  </th>
                  <th className="px-4 py-1.5">
                    <Select
                      value={filterAction}
                      onChange={v => setFilterAction(v as '' | 'Created' | 'Updated')}
                      triggerClassName="h-7 text-xs"
                      options={selectOptionsWithBlank('All', [
                  ...
                  <th className="px-4 py-1.5">
                    <Select
                      ...
                      triggerClassName="h-7 text-xs"
                      options={selectOptionsWithBlank('All', uniqueFields.map(f => ({ value: f, label: f })))}
                    />
                  </th>
                  <th className="px-4 py-1.5">
                    <input
