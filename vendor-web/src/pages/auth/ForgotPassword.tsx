  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? 'bg-white shadow-sm text-violet-700' : 'text-gray-500 hover:text-gray-700',
      )}
    >
        ...
        {step === 'request' ? (
          ...
          <form onSubmit={onResetPassword} className="space-y-4">
            ...
            <button
              type="button"
              onClick={resetAll}
              className="w-full text-xs text-gray-500 hover:text-violet-600 text-center transition-colors"
            >
              ← Back / resend code
            </button>
          </form>
          ...
          <div className="space-y-1.5">
            {SUPPORT_PHONE && (
              <a
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 text-sm text-gray-700 hover:bg-violet-50 hover:border-violet-200 transition-colors"
              >
