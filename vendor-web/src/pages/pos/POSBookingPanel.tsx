...
export function POSBookingPanel({
  ...
  return (
    ...
    >
      <div
        className="bg-card border border-border text-foreground rounded-2xl shadow-2xl w-full max-w-3xl max-h-[92vh] flex flex-col overflow-hidden"
      ...
      >
        ...
        <div className="grid grid-cols-2 divide-x border-b bg-accent">
          <div className="flex items-center gap-2.5 px-5 py-3">
            ...
            <div>
              <p className="text-xs font-medium text-primary/70 uppercase tracking-wide">Standard Slot</p>
          ...
          <div className="flex items-center gap-2.5 px-5 py-3">
            ...
            <div>
              <p className="text-xs font-medium text-primary/70 uppercase tracking-wide">Base Price</p>
              ...
              {customer && (
                <div className="flex items-center gap-2 p-2.5 bg-accent border border-primary/30 rounded-xl">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-medium text-gray-900 truncate">{customer.full_name}</p>
        ...
        <div className="border-t bg-gray-50 px-6 py-4 flex items-center gap-3">
          ...
          {onOpenFullBooking && (
            <Button
              type="button"
              variant="outline"
              className="h-10 px-4 text-xs font-medium border-primary/30 text-primary hover:bg-accent gap-1.5"
          ...
          {selectedDuration > 0 && !durationError && (
            <div className="text-right hidden sm:block">
              <p className="text-xs text-gray-400 uppercase font-semibold tracking-wide">Selected Duration</p>
      ...
      {showConfirm && overriddenPrice !== null && (
        <div data-kiterp-modal className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-y-auto" onClick={() => setShowConfirm(false)}>
          <div className="bg-card border border-border text-foreground rounded-2xl shadow-2xl w-full max-w-md p-6 space-y-5 max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
