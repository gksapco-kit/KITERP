            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b bg-gray-50">
                  <th className="text-left px-4 py-2.5"><button className="flex items-center gap-1 text-xs font-medium text-gray-500 uppercase hover:text-gray-800" onClick={() => toggleSort('version')}>Version <SortIcon col="version" /></button></th>
                  <th className="text-left px-4 py-2.5"><button className="flex items-center gap-1 text-xs font-medium text-gray-500 uppercase hover:text-gray-800" onClick={() => toggleSort('timestampRaw')}>Timestamp <SortIcon col="timestampRaw" /></button></th>
                  <th className="text-left px-4 py-2.5"><button className="flex items-center gap-1 text-xs font-medium text-gray-500 uppercase hover:text-gray-800" onClick={() => toggleSort('changedBy')}>Changed By <SortIcon col="changedBy" /></button></th>
                  <th className="text-left px-4 py-2.5"><button className="flex items-center gap-1 text-xs font-medium text-gray-500 uppercase hover:text-gray-800" onClick={() => toggleSort('action')}>Action <SortIcon col="action" /></button></th>
                  <th className="text-left px-4 py-2.5"><button className="flex items-center gap-1 text-xs font-medium text-gray-500 uppercase hover:text-gray-800" onClick={() => toggleSort('field')}>Field <SortIcon col="field" /></button></th>
                  <th className="text-left px-4 py-2.5"><button className="flex items-center gap-1 text-xs font-medium text-gray-500 uppercase hover:text-gray-800" onClick={() => toggleSort('oldValue')}>Old Value <SortIcon col="oldValue" /></button></th>
