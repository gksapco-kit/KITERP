...
export default function CourseLearningPage() {
  ...
  const { data: enrollment } = useHREnrollment(id)
  ...
  if (!enr || !prog) return <div className="p-6 text-gray-400">Loading…</div>
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <Link to="/hr/my-training" className="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700 mb-3">
        <ArrowLeft className="w-4 h-4" /> Back to my training
      </Link>
