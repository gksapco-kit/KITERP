...
export default function OrderDetail() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
            ...
            {['confirmed', 'processing', 'shipped'].includes(order.status) && (
              <div className="flex gap-2">
                <Select
                  ...
                  onChange={setSelectedDeliveryStaff}
      ...
      {showResolveModal && (
        <div data-kiterp-modal className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 overflow-y-auto" onClick={() => setShowResolveModal(null)}>
