...
export function AddColourOptionModal({ vendorId, onClose, onCreated }: Props) {
  ...
  return (
    <ModalOverlay onClose={onClose}>
      <ModalPanel className="max-w-md w-full">
        <ModalHeader
          title="Add Colours"
          subtitle={<p className="text-sm text-muted-foreground mt-0.5">Pick a colour from the palette or code — the name fills in automatically.</p>}
          onClose={onClose}
        />
