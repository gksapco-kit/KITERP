  ...
  return (
    <div className="border border-primary/30 rounded-2xl bg-gradient-to-br from-accent/60 to-accent/60 p-4 mt-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-xs font-extrabold uppercase tracking-wide text-primary">Customize style</span>
        <span className="text-xs text-gray-400 ml-auto">Live preview below</span>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {/* Colors */}
        <div>
          <div className="text-xs font-bold uppercase tracking-wide text-gray-500 mb-2">Brand colors</div>
            ...
            {(
              ...
              <label key={label} className="flex items-center gap-2 cursor-pointer group">
                ...
                <input
                  ...
                  maxLength={7}
                  placeholder="#000000"
                  className="flex-1 min-w-0 font-mono text-xs px-2 py-1 border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-1 focus:ring-ring text-gray-800"
                />
              </label>
            ))}
          </div>
        ...
        <div className="space-y-3">
          ...
          <div>
            <div className="text-xs font-bold uppercase tracking-wide text-gray-500 mb-2">Store name</div>
            <input
              type="text"
              value={storeName}
              onChange={e => setStoreName(e.target.value)}
              placeholder="My Store"
              className="w-full text-xs px-2.5 py-1.5 border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-1 focus:ring-ring text-gray-800"
            />
          </div>
      ...
      <div className="flex items-center gap-2 mt-3 pt-3 border-t border-primary/20">
        <button
          type="button"
          onClick={reset}
          className="inline-flex items-center gap-1.5 text-xs font-medium text-gray-500 hover:text-gray-700 px-2.5 py-1.5 rounded-lg hover:bg-gray-100 transition-colors"
        >
        ...
        <a
          ...
          className="ml-auto inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-extrabold bg-gradient-to-r from-primary to-emerald-700 text-white hover:opacity-90 transition-opacity shadow-sm"
        >
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                {siteLabel && (
                  <p className="text-xs text-primary font-semibold mt-1 truncate">Apply to: {siteLabel}</p>
                )}
        ...
        <div className="p-5 overflow-y-auto min-h-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="border border-gray-100 rounded-2xl p-4">
              <div className="text-xs font-extrabold uppercase tracking-wide text-gray-400 mb-2">Pages included</div>
                ...
                {(template.pages || []).map((p) => {
                  ...
                  return (
                    <div key={p.slug} className="flex items-center gap-2 px-2.5 py-2 rounded-xl bg-gray-50 border border-gray-100">
                      <span className={cn('text-xs font-extrabold px-1.5 py-0.5 rounded-md',
            ...
            {/* What you get + apply */}
            <div className="border border-gray-100 rounded-2xl p-4">
              <div className="text-xs font-extrabold uppercase tracking-wide text-gray-400 mb-2">What you get</div>
