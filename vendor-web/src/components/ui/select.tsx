...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      `flex h-9 w-full items-center justify-between rounded-md ${formFieldBorderClassName} bg-transparent px-3 py-2 text-sm shadow-sm placeholder:text-muted-foreground ${formFieldFocusClassName} disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1`,
      className,
    )}
    {...props}
  >
