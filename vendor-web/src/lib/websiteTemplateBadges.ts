...
export const templateCardShellClass =
  'group/card flex cursor-pointer flex-col overflow-hidden rounded-2xl border border-gray-200/90 bg-white text-left shadow-sm transition-all duration-200 ease-out hover:border-primary/55 hover:ring-2 hover:ring-primary/20 hover:shadow-[0_14px_36px_rgba(19,98,74,0.16)] motion-safe:hover:-translate-y-1 dark:border-border dark:bg-card dark:hover:shadow-[0_14px_36px_rgba(0,0,0,0.35)]'

export const templateCardMediaHeightClass = 'h-24 sm:h-28'

export const templateCardBodyClass =
  'flex flex-col p-2.5 pt-2 transition-colors group-hover/card:bg-primary/[0.02] dark:group-hover/card:bg-primary/5'
