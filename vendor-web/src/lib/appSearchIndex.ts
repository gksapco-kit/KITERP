...
const KEYWORD_HINTS: Record<string, string[]> = {
  ...
  'Support audit':                        ['support', 'audit', 'activity', 'platform', 'log'],
  ...
  'Rental Report Analytics':             ['rental report', 'rental analytics', 'rental revenue', 'rental bookings report', 'asset utilization', 'rental dashboard'],
  'Registration Forms':                   ['rental form', 'registration form', 'google form', 'kyc', 'intake', 'register and book'],
  'Filled Registrations':                 ['filled registration', 'registration submissions', 'customer registration', 'kyc answers', 'register customer', 'discarded', 'restore registration'],
...
export const EXTRA_NAV_ENTRIES: NavSearchEntry[] = [
  ...
  { kind: 'nav', id: 'support-activity',   label: 'Support audit',            description: 'Relationship Manager → Platform support log', section: 'My Kit',             sectionId: 'my-kit',    to: '/settings/support-activity', keywords: ['support', 'audit', 'activity', 'platform', 'log'] },
  ...
  { kind: 'nav', id: 'storefront-builder-legacy', label: 'Business Front Builder (legacy)', description: 'Redirects to Business Website Builder', section: 'Website Management', sectionId: 'website-management', to: '/websites', keywords: ['storefront builder', 'business front builder', 'front builder'] },
