...
export const BLOCK_QUICK_PRESETS: Record<string, SectionLayoutPreset[]> = {
  ...
  about_split: [
    ...
    { label: 'Two Column Text', desc: 'Split text columns', props: { layout: 'split', image_position: 'none' } },
    { label: 'Stats + Story', desc: 'About with inline stats', props: { image_position: 'left', show_stats: true } },
    { label: 'Video About', desc: 'Video embed beside story', props: { image_position: 'right', media_type: 'video' } },
    { label: 'Dark About', desc: 'About section on dark bg', props: { image_position: 'left', bg_style: 'dark' } },
    { label: 'Card About', desc: 'Content in bordered card', props: { image_position: 'left', card_style: 'card' } },
