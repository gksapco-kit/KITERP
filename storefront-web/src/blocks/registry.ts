...
export const BLOCK_CATALOG: BlockDef[] = [
  ...
  { type: 'product_grid', label: 'Product Grid', desc: 'Display products from your catalog', category: 'ecommerce', defaultProps: { title: 'Featured Products', columns: 4, show_badges: true, padding_top: 64, padding_bottom: 64, image_object_fit: 'contain' }, liveResource: 'products' },
  ...
  { type: 'related_products', label: 'Related Products', desc: 'Cross-sell / upsell grid', category: 'ecommerce', defaultProps: { title: 'You May Also Like', count: 4, padding_top: 32, padding_bottom: 32, item_gap: 12, card_padding: 10, image_object_fit: 'contain' }, liveResource: 'products' },
