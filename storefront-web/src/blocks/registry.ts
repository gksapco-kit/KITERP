...
export const BLOCK_CATALOG: BlockDef[] = [
  ...
  { type: 'testimonials', label: 'Testimonials', desc: 'Customer reviews and quotes', category: 'social', defaultProps: { title: 'What Our Customers Say', testimonials: [] }, liveResource: 'testimonials' },
  ...
  { type: 'product_grid', label: 'Product Grid', desc: 'Display products from your catalog', category: 'ecommerce', defaultProps: { title: 'Featured Products', columns: 4, show_badges: true }, liveResource: 'products' },
  ...
  { type: 'related_products', label: 'Related Products', desc: 'Cross-sell / upsell grid', category: 'ecommerce', defaultProps: { title: 'You May Also Like', count: 4 }, liveResource: 'products' },
