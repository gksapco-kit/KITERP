...
export const BLOCK_CATALOG: BlockDef[] = [
  // Structure
  { type: 'nav', label: 'Navigation', desc: 'Top navigation with logo and links', category: 'structure', defaultProps: { brand: 'Your Brand', brand_logo: '', show_logo: true, show_brand_name: true, brand_layout: 'horizontal', logo_size: 52, logo_shape: 'original', logo_fit: 'contain', brand_gap: 8, brand_name_size: 'md', show_nav_links: true, nav_links_source: 'site_pages', nav_links: [{ label: 'About', url: '/about' }, { label: 'Contact', url: '/contact' }], show_search: true, show_cart: true, show_login: true, cta_label: 'Get Started' }, liveResource: 'pages' },
  { type: 'footer', label: 'Footer', desc: 'Site footer with links and copyright', category: 'structure', defaultProps: { copyright: '© 2026 Your Company. All rights reserved.', columns: 4, show_social: true, show_powered_by: true, powered_by_text: 'Powered By @ KITERP.com', powered_by_text_url: 'https://kiterp.com/', powered_by_text_link_new_tab: true, social_links: { whatsapp: '', twitter: '', facebook: '', instagram: '', youtube: '' } }, liveResource: 'pages' },
  ...
  { type: 'gallery_masonry', label: 'Gallery Masonry', desc: 'Masonry image gallery', category: 'media', defaultProps: { title: 'Gallery', show_nav: true, page_size: 6 }, liveResource: 'media' },
  ...
  { type: 'product_grid', label: 'Product Grid', desc: 'Display products from your catalog', category: 'ecommerce', defaultProps: { title: 'Featured Products', columns: 4, show_badges: true, padding_top: 64, padding_bottom: 64, image_object_fit: 'contain', add_button_style: 'filled' }, liveResource: 'products' },
  ...
  { type: 'related_products', label: 'Related Products', desc: 'Cross-sell / upsell grid', category: 'ecommerce', defaultProps: { title: 'You May Also Like', count: 4, padding_top: 32, padding_bottom: 32, item_gap: 12, card_padding: 10, image_object_fit: 'contain', add_button_style: 'filled' }, liveResource: 'products' },
