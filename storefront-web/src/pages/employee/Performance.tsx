  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Goals, reviews, and feedback</p>
      </div>
          ...
          {goals.length === 0 ? (
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b text-xs uppercase text-gray-500">
                <tr>
                  {['Title', 'Target Date', 'Progress', 'Status'].map((h) => (
                  ...
                  return (
                    <tr key={r.id} className="border-b hover:bg-gray-50">
                      <td className="py-3 px-4 text-sm font-mono text-gray-500">
                        {String(r.cycle_id ?? r.id).slice(0, 8)}
                      </td>
                      <td className="py-3 px-4">
            ...
            <div key={f.id} className="p-4">
              <div className="flex items-center justify-between mb-1">
                <p className="text-sm font-medium capitalize">
                  {f.title ?? f.feedback_type ?? 'Feedback'}
                </p>
