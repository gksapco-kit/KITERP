...
class StorefrontContactQueryCreate(BaseModel):
    ...
    @field_validator("name", "first_name", "last_name", "title", "company", "source", "referral_name", "phone")
    @classmethod
    ...
    @classmethod
    def strip_message(cls, v: Optional[str]) -> str:
        return (v or "").strip()
    ...
    def require_identity(self):
        ...
        if composed:
            ...
            self.name = (self.email and str(self.email).split("@", 1)[0]) or "Contact"
        return self
