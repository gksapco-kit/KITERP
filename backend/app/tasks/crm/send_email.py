...
async def _send(vendor_id: UUID, contact_id: UUID | None, subject: str, body_html: str,
                body_text: str | None = None, campaign_id: UUID | None = None) -> dict:
...
def send_email_now(vendor_id: UUID, contact_id: UUID | None, subject: str,
                   ...
                   campaign_id: UUID | None = None) -> dict:
    """Sync entry point for inline calls."""
    return asyncio.run(_send(vendor_id, contact_id, subject, body_html, body_text, campaign_id))
