...
WEBSITE_TEMPLATES = {
    "landing": {
        "id": "landing", "name": "Landing Page", "description": "High-conversion single-page layout",
        ...
        "pages": [{"title": "Home", "slug": "home", "page_type": "home", "is_homepage": True, "blocks": [
            {"block_type": "nav", "props": {"brand": "Your Brand", "transparent": True}},
            {"block_type": "hero", "props": {"headline": "Transform Your Business Today", "subtitle": "The all-in-one platform that helps you grow faster.", "bg_style": "gradient", "cta_primary": "Get Started Free", "cta_secondary": "Watch Demo"}},
            {"block_type": "trust_logos", "props": {"title": "Trusted by 10,000+ companies"}},
            {"block_type": "features", "props": {"title": "Everything You Need", "layout": "grid-3"}},
            {"block_type": "stats", "props": {"stats": [{"value": "10K+", "label": "Happy Customers"}, {"value": "99.9%", "label": "Uptime"}, {"value": "4.9★", "label": "Rating"}]}},
            {"block_type": "testimonials", "props": {"title": "Loved by thousands"}},
            {"block_type": "pricing", "props": {"title": "Simple, transparent pricing"}},
            {"block_type": "cta", "props": {"headline": "Ready to get started?", "cta_label": "Start Free Trial"}},
            {"block_type": "footer", "props": _footer_props_standard()},
        ]}],
    },
    "portfolio": {
    ...
    "ecommerce": {
        "id": "ecommerce", "name": "E-Commerce Store", "description": "Full online store with product catalog",
        ...
        "pages": [
            {"title": "Home", "slug": "home", "page_type": "home", "is_homepage": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Shop Name", "show_cart": True, "show_search": True}},
                {"block_type": "announcement_bar", "props": {"text": "Free shipping on orders over $50", "color": "#2563eb"}},
                {"block_type": "hero", "props": {"headline": "New Season Arrivals", "subtitle": "Discover our latest collection", "bg_style": "image", "cta_primary": "Shop Now"}},
                {"block_type": "category_cards", "props": {"title": "Shop by Category", "columns": 4}},
                {"block_type": "product_grid", "props": {"title": "Featured Products", "columns": 4, "show_badges": True}},
                {"block_type": "offer_banner", "props": {"headline": "Up to 50% Off", "subtitle": "Limited time offer"}},
                {"block_type": "testimonials", "props": {"title": "Customer Reviews"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
        ],
    },
    "blog": {
        "id": "blog", "name": "Blog / Magazine", "description": "Content-first editorial layout",
        ...
        "pages": [
            {"title": "Home", "slug": "home", "page_type": "home", "is_homepage": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Blog", "layout": "centered"}},
                {"block_type": "hero", "props": {"headline": "Stories Worth Reading", "subtitle": "Insights, ideas, and inspiration", "bg_style": "minimal", "layout": "centered"}},
                {"block_type": "blog_featured", "props": {"title": "Featured Post", "layout": "large"}},
                {"block_type": "blog_grid", "props": {"title": "Latest Posts", "columns": 3}},
                {"block_type": "newsletter", "props": {"title": "Subscribe to our newsletter"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
        ],
    },
    "restaurant": {
        "id": "restaurant", "name": "Restaurant", "description": "Appetizing layout with menu sections",
        ...
        "pages": [
            {"title": "Home", "slug": "home", "page_type": "home", "is_homepage": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Restaurant Name", "show_reservation": True}},
                {"block_type": "hero", "props": {"headline": "A Dining Experience Like No Other", "subtitle": "Fresh ingredients, unforgettable flavors", "bg_style": "image", "overlay": True, "cta_primary": "Reserve a Table", "cta_secondary": "View Menu"}},
                {"block_type": "features", "props": {"title": "Why We're Special", "layout": "grid-3", "icon_style": "emoji"}},
                {"block_type": "menu_grid", "props": {"title": "Our Menu", "categories": ["Starters", "Mains", "Desserts", "Drinks"]}},
                {"block_type": "gallery_masonry", "props": {"title": "Gallery"}},
                {"block_type": "testimonials", "props": {"title": "What Guests Say"}},
                {"block_type": "map_contact", "props": {"title": "Find Us"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
        ],
    },
    "corporate": {
        ...
        "pages": [
            {"title": "Home", "slug": "home", "page_type": "home", "is_homepage": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Company Name", "layout": "default"}},
                {"block_type": "hero", "props": {"headline": "Building Tomorrow's Solutions Today", "subtitle": "We partner with leading organizations to drive digital transformation.", "bg_style": "gradient", "cta_primary": "Get In Touch", "cta_secondary": "Our Services"}},
                {"block_type": "trust_logos", "props": {"title": "Trusted Partners"}},
                {"block_type": "features", "props": {"title": "Our Core Services", "layout": "grid-3"}},
                {"block_type": "stats", "props": {"title": "Numbers That Speak"}},
                {"block_type": "team_grid", "props": {"title": "Leadership Team", "columns": 4}},
                {"block_type": "testimonials", "props": {"title": "Client Success Stories"}},
                {"block_type": "cta", "props": {"headline": "Ready to transform your business?", "cta_label": "Start a Conversation"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "About", "slug": "about", "page_type": "about", "blocks": [
                {"block_type": "hero", "props": {"headline": "About Us", "subtitle": "Our story, mission, and values", "bg_style": "minimal", "layout": "centered"}},
                {"block_type": "about_split", "props": {}},
                {"block_type": "timeline", "props": {"title": "Our Journey"}},
                {"block_type": "team_grid", "props": {"title": "Meet the Team"}},
            ]},
            {"title": "Services", "slug": "services", "page_type": "services", "blocks": [
                {"block_type": "hero", "props": {"headline": "Our Services", "bg_style": "minimal", "layout": "centered"}},
                {"block_type": "services_cards", "props": {"columns": 3}},
                {"block_type": "cta", "props": {"headline": "Have a project in mind?"}},
            ]},
            {"title": "Contact", "slug": "contact", "page_type": "contact", "blocks": [
                {"block_type": "contact_form", "props": {"title": "Get In Touch", "full_page": True}},
                {"block_type": "map_contact", "props": {}},
            ]},
        ],
    },
    "saas": {
        "id": "saas", "name": "SaaS / App", "description": "Modern software product landing page",
        "thumbnail": "https://images.unsplash.com/photo-1551650975-87deedd944c3?w=600",
        "category": "tech",
        "pages": [
            {"title": "Home", "slug": "home", "page_type": "home", "is_homepage": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "AppName", "cta_label": "Start Free", "show_login": True}},
                {"block_type": "hero", "props": {"headline": "The Smarter Way to Manage Everything", "subtitle": "Automate your workflow. Save 10+ hours per week.", "bg_style": "gradient", "cta_primary": "Start for Free", "cta_secondary": "See Demo", "show_dashboard_preview": True}},
                {"block_type": "trust_logos", "props": {"title": "Used by teams at"}},
                {"block_type": "features", "props": {"title": "Built for Modern Teams", "layout": "alternating"}},
                {"block_type": "demo_video", "props": {"title": "See It In Action"}},
                {"block_type": "stats", "props": {}},
                {"block_type": "pricing", "props": {"title": "Start Free, Scale as You Grow", "show_annual_toggle": True}},
                {"block_type": "faq", "props": {"title": "Frequently Asked Questions"}},
                {"block_type": "testimonials", "props": {"title": "Loved by 50,000+ users"}},
                {"block_type": "cta", "props": {"headline": "Start your free 14-day trial", "cta_label": "Get Started Free", "show_credit_card_note": True}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
        ],
    },
    "nonprofit": {
        "id": "nonprofit", "name": "Nonprofit / Charity", "description": "Inspiring layout for mission-driven organizations",
        "thumbnail": "https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=600",
        "category": "nonprofit",
        "pages": [
            {"title": "Home", "slug": "home", "page_type": "home", "is_homepage": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Org Name", "cta_label": "Donate Now"}},
                {"block_type": "hero", "props": {"headline": "Together We Make a Difference", "subtitle": "Join thousands of supporters changing lives around the world.", "bg_style": "image", "overlay": True, "cta_primary": "Donate Now", "cta_secondary": "Learn More"}},
                {"block_type": "impact_stats", "props": {"stats": [{"value": "50K+", "label": "Lives Changed"}, {"value": "120", "label": "Countries"}, {"value": "$2M+", "label": "Raised"}]}},
                {"block_type": "features", "props": {"title": "Our Programs", "layout": "grid-3"}},
                {"block_type": "stories", "props": {"title": "Stories of Impact"}},
                {"block_type": "donate_cta", "props": {"headline": "Your Donation Changes Lives"}},
                {"block_type": "testimonials", "props": {"title": "Volunteer Voices"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
        ],
    },
    # ── Candy / pictorial presets (UI-first, ERP-friendly) ──────────────────
    "candy_retail_fiesta": {
        "id": "candy_retail_fiesta",
        "name": "Candy Retail Fiesta",
        "description": "Bright, pictorial store — products, categories, and fast conversion.",
        "thumbnail": "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=800",
        "category": "retail",
        "tier": "full",
        "preview_palette": ["#E11D96", "#7C3AED", "#FBBF24", "#FFF1F7", "#0F172A"],
        "default_style": {
            "primary_color": "#E11D96",
        ...
        "pages": [
            {"title": "Home", "slug": "home", "page_type": "home", "is_homepage": True, "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Store", "show_cart": True, "show_search": True}},
                {"block_type": "announcement_bar", "props": {"text": "🎀 New arrivals every week — free shipping above ₹999", "color": "#E11D96", "show_close": True}},
                {"block_type": "hero", "props": {"headline": "Colorful picks you’ll love", "subtitle": "Shop trending items, bundles, and limited drops.", "bg_style": "image", "image_url": "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=1600", "overlay": True, "cta_primary": "Shop now", "cta_primary_url": "/shop", "cta_secondary": "Browse categories", "cta_secondary_url": "/shop"}},
                {"block_type": "category_cards", "props": {"title": "Shop by category", "columns": 4}},
                {"block_type": "product_grid", "props": {"title": "Featured products", "columns": 4, "show_badges": True}},
                {"block_type": "live_stock", "props": {"title": "Live inventory", "show_count": 6}},
                {"block_type": "coupon_banner", "props": {"title": "Use code CANDY10 for 10% off!", "show_copy_button": True}},
                {"block_type": "payment_methods_strip", "props": {"title": "Secure payments", "methods": ["upi", "gpay", "visa", "mastercard", "cod"]}},
                {"block_type": "testimonials", "props": {"title": "Customers love us"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Shop", "slug": "shop", "page_type": "custom", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Store", "show_cart": True, "show_search": True}},
                {"block_type": "search_bar", "props": {"placeholder": "Search products…", "show_filters": True}},
                {"block_type": "product_filters", "props": {"show_price": True, "show_category": True, "show_brand": True}},
                {"block_type": "product_grid", "props": {"title": "All products", "columns": 4, "show_badges": True}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Product", "slug": "product", "page_type": "custom", "show_in_nav": False, "blocks": [
                {"block_type": "product_detail", "props": {"show_variants": True, "show_reviews": True}},
                {"block_type": "related_products", "props": {"title": "You may also like", "count": 4}},
                {"block_type": "product_reviews", "props": {"title": "Reviews", "show_summary": True}},
                {"block_type": "cart_drawer", "props": {"title": "Your cart", "show_upsells": True}},
                {"block_type": "checkout_form", "props": {"allow_cod": True}},
            ]},
            {"title": "About", "slug": "about", "page_type": "about", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Store", "show_cart": True}},
                {"block_type": "about_split", "props": {"title": "About us", "subtitle": "Our story", "description": "A modern store built for delightful shopping."}},
                {"block_type": "gallery_masonry", "props": {"title": "Lookbook"}},
                {"block_type": "team_grid", "props": {"title": "Meet the team", "columns": 4}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Contact", "slug": "contact", "page_type": "contact", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Store"}},
                {"block_type": "contact_form", "props": {"title": "Contact us", "full_page": True}},
                {"block_type": "map_embed", "props": {"title": "Find us", "address": ""}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Policies", "slug": "policies", "page_type": "custom", "show_in_nav": False, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Store"}},
                {"block_type": "rich_text", "props": {"content": "<h2>Shipping & Returns</h2><p>Add your shipping and return policy here.</p><h3>Privacy</h3><p>Add your privacy policy here.</p>"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "FAQ", "slug": "faq", "page_type": "custom", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Store"}},
                {"block_type": "faq", "props": {"title": "Frequently asked questions", "faqs": [{"question": "How long does delivery take?", "answer": "Typically 2–5 business days, depending on location."}, {"question": "Can I return items?", "answer": "Yes. Returns are accepted as per our policy page."}]}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Track Order", "slug": "track", "page_type": "custom", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Store"}},
    ...
    "candy_services_spa": {
        "id": "candy_services_spa",
        "name": "Candy Services Spa",
        "description": "Candy-bright services site with booking and gallery.",
        "thumbnail": "https://images.unsplash.com/photo-1522336572468-97b06e8ef143?w=800",
        "category": "services",
        "tier": "full",
        "preview_palette": ["#10B981", "#6366F1", "#F472B6", "#F0FDF4", "#0F172A"],
        "default_style": {
        ...
        "pages": [
            {"title": "Home", "slug": "home", "page_type": "home", "is_homepage": True, "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Studio", "cta_label": "Book now", "cta_url": "/book"}},
                {"block_type": "hero_split", "props": {"headline": "Feel good, look great", "subtitle": "Premium services with instant booking.", "bg_style": "image", "image_url": "https://images.unsplash.com/photo-1522336572468-97b06e8ef143?w=1600", "cta_primary": "Book a slot", "cta_primary_url": "/book"}},
                {"block_type": "services_cards", "props": {"title": "Popular services", "columns": 3}},
                {"block_type": "booking_slot_picker", "props": {"title": "Book an appointment", "subtitle": "Choose a service, date, and time"}},
                {"block_type": "testimonials", "props": {"title": "What clients say"}},
                {"block_type": "gallery_masonry", "props": {"title": "Results gallery"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Services", "slug": "services", "page_type": "services", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Studio", "cta_label": "Book now", "cta_url": "/book"}},
                {"block_type": "services_cards", "props": {"title": "All services", "columns": 3}},
            ...
            {"title": "Book", "slug": "book", "page_type": "custom", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Studio"}},
                {"block_type": "booking_slot_picker", "props": {"title": "Book your slot", "subtitle": "Pick a service and time"}},
                {"block_type": "faq", "props": {"title": "Booking FAQs", "faqs": [{"question": "Can I reschedule?", "answer": "Yes. You can reschedule from your booking confirmation."}, {"question": "Do you accept walk-ins?", "answer": "Walk-ins are welcome if a slot is available."}]}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "About", "slug": "about", "page_type": "about", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Studio"}},
                {"block_type": "about_split", "props": {"title": "About us", "subtitle": "Our promise", "description": "A friendly team, quality products, and great experience."}},
                {"block_type": "team_grid", "props": {"title": "Our team", "columns": 4}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Contact", "slug": "contact", "page_type": "contact", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Studio"}},
                {"block_type": "contact_form", "props": {"title": "Contact", "full_page": True}},
                {"block_type": "map_embed", "props": {"title": "Visit us", "address": ""}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Policies", "slug": "policies", "page_type": "custom", "show_in_nav": False, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Studio"}},
                {"block_type": "rich_text", "props": {"content": "<h2>Policies</h2><p>Add cancellation, rescheduling, and refund policies here.</p>"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Gallery", "slug": "gallery", "page_type": "custom", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Studio"}},
                {"block_type": "gallery_masonry", "props": {"title": "Gallery"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
    ...
    "candy_food_glow": {
        "id": "candy_food_glow",
        "name": "Candy Food Glow",
        "description": "Warm, pictorial restaurant site — menu, gallery, and location.",
        "thumbnail": "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=800",
        "category": "food",
        "tier": "full",
        "preview_palette": ["#F97316", "#0EA5E9", "#A3E635", "#FFFBEB", "#0F172A"],
        "default_style": {
            "primary_color": "#F97316",
        ...
        "pages": [
            {"title": "Home", "slug": "home", "page_type": "home", "is_homepage": True, "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Restaurant", "cta_label": "Reserve", "cta_url": "/contact"}},
                {"block_type": "hero", "props": {"headline": "Fresh. Fun. Flavorful.", "subtitle": "A menu crafted with love — order, dine in, or takeaway.", "bg_style": "image", "image_url": "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=1600", "overlay": True, "cta_primary": "View menu", "cta_primary_url": "/menu", "cta_secondary": "Find us", "cta_secondary_url": "/contact"}},
                {"block_type": "menu_grid", "props": {"title": "Popular menu", "categories": ["Starters", "Mains", "Desserts", "Drinks"]}},
                {"block_type": "gallery_masonry", "props": {"title": "Food gallery"}},
                {"block_type": "testimonials", "props": {"title": "Guest reviews"}},
                {"block_type": "map_embed", "props": {"title": "Visit us", "address": ""}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Menu", "slug": "menu", "page_type": "custom", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Restaurant"}},
                {"block_type": "menu_grid", "props": {"title": "Menu", "categories": ["Starters", "Mains", "Desserts", "Drinks"]}},
                {"block_type": "live_stock", "props": {"title": "What’s available now", "show_count": 6}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "About", "slug": "about", "page_type": "about", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Restaurant"}},
                {"block_type": "about_split", "props": {"title": "Our story", "subtitle": "From our kitchen to you", "description": "Tell your story, your ingredients, and what makes you special."}},
                {"block_type": "gallery_masonry", "props": {"title": "Behind the scenes"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Contact", "slug": "contact", "page_type": "contact", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Restaurant"}},
                {"block_type": "contact_form", "props": {"title": "Contact & reservations", "full_page": True}},
                {"block_type": "map_embed", "props": {"title": "Find us", "address": ""}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Gallery", "slug": "gallery", "page_type": "custom", "show_in_nav": True, "blocks": [
            ...
            {"title": "Policies", "slug": "policies", "page_type": "custom", "show_in_nav": False, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Restaurant"}},
                {"block_type": "rich_text", "props": {"content": "<h2>Policies</h2><p>Add reservation, cancellation, and refund policies here.</p>"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "FAQ", "slug": "faq", "page_type": "custom", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Your Restaurant"}},
                {"block_type": "faq", "props": {"title": "FAQs", "faqs": [{"question": "Do you offer takeaway?", "answer": "Yes, takeaway is available during open hours."}, {"question": "Do you have vegetarian options?", "answer": "Yes, plenty. Mark items in your ERP and we’ll show them in the menu."}]}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
        ],
    },
    ...
    "storefront_restaurant": {
        "id": "storefront_restaurant",
        "name": "Larder",
        "description": "Menu-first restaurant layout with sections, item modals, add-ons, and a sticky cart \u2014 ideal for restaurants, caf\u00e9s, and cloud kitchens.",
        "thumbnail": "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=800",
        "category": "food",
        "tier": "full",
        "tags": ["Restaurant", "Caf\u00e9", "Cloud Kitchen", "Menu", "Reservations"],
        "preview_palette": ["#1A120E", "#E8A635", "#1E1914", "#3D2B1E", "#F6F3EE"],
        "default_style": {
            "primary_color": "#1A120E", "secondary_color": "#E8A635", "accent_color": "#E8A635",
            "bg_color": "#1E1914", "surface_color": "#1A120E", "text_color": "#F6F3EE",
        ...
        "pages": [
            {"title": "Home", "slug": "home", "page_type": "home", "is_homepage": True, "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Larder", "show_reservation": True}},
                {"block_type": "hero", "props": {"headline": "A modern table, set in the old way.", "subtitle": "Wood-fired plates, low-intervention wines and a menu that changes with what arrives at the door.", "bg_style": "image", "image_url": "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=1600", "overlay": True, "cta_primary": "Reserve a table", "cta_secondary": "Order takeout"}},
                {"block_type": "menu_grid", "props": {"title": "What we\u2019re cooking", "categories": ["Starters", "Mains", "Desserts"]}},
                {"block_type": "gallery_masonry", "props": {"title": "Gallery"}},
                {"block_type": "testimonials", "props": {"title": "Guest voices"}},
                {"block_type": "map_contact", "props": {"title": "Find us"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Menu", "slug": "menu", "page_type": "custom", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Larder"}},
                {"block_type": "menu_grid", "props": {"title": "Full menu", "categories": ["Starters", "Mains", "Desserts", "Drinks"]}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "Reservations", "slug": "reserve", "page_type": "custom", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Larder"}},
                {"block_type": "booking_slot_picker", "props": {"title": "Reserve a table", "subtitle": "Choose your date and party size"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
            {"title": "About", "slug": "about", "page_type": "about", "show_in_nav": True, "blocks": [
                {"block_type": "nav", "props": {"brand": "Larder"}},
                {"block_type": "about_split", "props": {"title": "Our story", "subtitle": "From the kitchen"}},
                {"block_type": "gallery_masonry", "props": {"title": "Behind the scenes"}},
                {"block_type": "footer", "props": _footer_props_standard()},
            ]},
...
TEMPLATE_STYLE_FALLBACKS = {
    "landing": {
        ...
        "bg_color": "#FFFFFF", "surface_color": "#F5F3FF", "text_color": "#0F172A",
    ...
    "ecommerce": {
        "primary_color": "#2563EB", "secondary_color": "#1D4ED8", "accent_color": "#F59E0B",
        "bg_color": "#FFFFFF", "surface_color": "#F1F5F9", "text_color": "#0F172A",
        "font_heading": "Inter", "font_body": "Inter", "border_radius": "rounded",
        "spacing": "comfortable", "animation": "subtle", "button_style": "filled",
    },
    "blog": {
        "primary_color": "#7C3AED", "secondary_color": "#4C1D95", "accent_color": "#8B5CF6",
        "bg_color": "#FFFFFF", "surface_color": "#F5F0FF", "text_color": "#0F172A",
        "font_heading": "Playfair Display", "font_body": "Inter", "border_radius": "rounded",
        "spacing": "spacious", "animation": "subtle", "button_style": "filled",
    },
    "restaurant": {
        "primary_color": "#F97316", "secondary_color": "#EA580C", "accent_color": "#EF4444",
        "bg_color": "#FFFBEB", "surface_color": "#FEF3C7", "text_color": "#1C1917",
        "nav_bg": "#1C1917", "font_heading": "Playfair Display", "font_body": "Inter",
        "border_radius": "rounded", "spacing": "spacious", "animation": "subtle", "button_style": "filled",
    },
    "corporate": {
        "primary_color": "#1E3A5F", "secondary_color": "#0F2A4A", "accent_color": "#2563EB",
        "bg_color": "#FFFFFF", "surface_color": "#F1F5F9", "text_color": "#0F172A",
        "font_heading": "Inter", "font_body": "Inter", "border_radius": "rounded",
        "spacing": "comfortable", "animation": "subtle", "button_style": "filled",
    },
