        ...
        "variants": [
            {
                ...
                "cost_price_fixed": _num(v.cost_price_fixed),
                "valuation_method": v.valuation_method,
                "cost_source": v.cost_source,
                "cost_updated_at": _dt(v.cost_updated_at) if hasattr(v, "cost_updated_at") else None,
...
def _build_variant(product_id, vc) -> ProductVariant:
    ...
    return ProductVariant(
        ...
        cost_price_fixed=g("cost_price_fixed"),
